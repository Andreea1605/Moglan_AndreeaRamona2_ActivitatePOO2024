...
private:
	Magazin magazin;          //nu mai apelam constructorul pentru ca este deja initializat, la constructorul fara parametri
	Cofetarie *cofetarie;      //relatia has a
	int nrMasiniParcate;
...
public:
	...
	ComplexComercial(Magazin mag, Cofetarie* cof, int nrMasini, Masina* masini) {
		this->magazin = mag; //se apeleaza operatorul=
		this->cofetarie = new Cofetarie(*cof); //se apeleaza constructorul de copiere
	...
	ComplexComercial(const ComplexComercial &cc) {
		this->magazin =cc.magazin; //se apeleaza operatorul=
		this->cofetarie = new Cofetarie(*(cc.cofetarie)); //se apeleaza constructorul de copiere
